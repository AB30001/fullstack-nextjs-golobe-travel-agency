...
const experienceSchema = new Schema(
  {
    ...
    pricingType: { 
      type: String, 
      enum: ["PER_PERSON", "UNIT"], 
      default: "PER_PERSON" 
    }, // UNIT = per group
    maxGroupSize: { type: Number, default: null }, // Max travelers for group pricing
    unitType: { type: String, default: null }, // GROUP, VEHICLE, BOAT, etc.
    ...
    cancellationPolicy: {
      type: {
        policyType: String, // STANDARD, ALL_SALES_FINAL, etc.
        description: String,
    ...
    languageGuides: [{
      guideType: String, // GUIDE, AUDIO_GUIDE, WRITTEN
